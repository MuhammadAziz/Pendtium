...
import islam.adhanalarm.services.StartNotificationService;

import java.util.Calendar;

import com.droidprojects.spotifytray.PlayerService;
...
//				.putExtras(intent));
		context.startService(new Intent(context, PlayerService.class).putExtras(intent));
	}
