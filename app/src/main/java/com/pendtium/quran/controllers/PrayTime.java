...
package com.pendtium.quran.controllers;
...
public class PrayTime {
    ...
    private double latidude; // latitude
    private double longitude; // longitude
    private double timeZone; // time-zone
    private double julianDate; // Julian date
    // ------------------------------------------------------------
    // Calculation Methods
    private int calcMethodJafari; // Ithna Ashari
    private int calcMethodKarachi; // University of Islamic Sciences, Karachi
    private int calcMethodISNA; // Islamic Society of North America (ISNA)
    private int calcMethodMWL; // Muslim World League (MWL)
    private int calcMethodMakkah; // Umm al-Qura, Makkah
    private int calcMethodEgypt; // Egyptian General Authority of Survey
    private int calcMethodCustom; // Custom Setting
    private int calcMethodTehran; // Institute of Geophysics, University of Tehran
    // Juristic Methods
    private int jurMethodShafii; // Shafii (standard)
    private int jurMethodHanafi; // Hanafi
    // Adjusting Methods for Higher Latitudes
    private int adjustNone; // No adjustment
    private int adjustMidNight; // middle of night
    private int adjustOneSeventh; // 1/7th of night
    private int adjustAngleBased; // angle/60th of night
    // Time Formats
    private int formatTime24; // 24-hour format
    private int formatTime12; // 12-hour format
    private int formatTime12NS; // 12-hour format with no suffix
    private int formatFloating; // floating point number
    // Time Names
    private static ArrayList<String> timeNames;
    private String timeInvalidTime; // The string used for invalid times
    // --------------------- Technical Settings --------------------
    ...
    public PrayTime() {
        ...
        timeInvalidTime = "-----"; // The string used for invalid times
...
//    }
	...
	if (adjustHighLats == adjustAngleBased)
		calc = (angle)/60.0;
	else if (adjustHighLats == adjustMidNight)
		calc = 0.5;
	else if (adjustHighLats == adjustOneSeventh)
		calc = 0.14286;
     ...
     * @return 
     */
    public static ArrayList<String> getPrayTimes() {
        double latitude = -8.73525;
        double longitude = 115.16965;
        double timezone = 8;
        // Test Prayer times here
        PrayTime prayers = new PrayTime();

        prayers.setTimeFormat(prayers.formatTime24);
        prayers.setCalcMethod(prayers.calcMethodKarachi);
        prayers.setAsrJuristic(prayers.jurMethodShafii);
        prayers.setAdjustHighLats(prayers.adjustAngleBased);
...
//        }
    ...
    private int getJafari() {
        return calcMethodJafari;
    }

    private void setJafari(int jafari) {
        calcMethodJafari = jafari;
    }

    private int getKarachi() {
        return calcMethodKarachi;
    }
    ...
    private int getShafii() {
        return jurMethodShafii;
    }

    private void setShafii(int shafii) {
        jurMethodShafii = shafii;
    }

    private int getHanafi() {
        return jurMethodHanafi;
    }

    private void setHanafi(int hanafi) {
        jurMethodHanafi = hanafi;
    }
    ...
    private int getTime12NS() {
        return formatTime12NS;
    }

    private void setTime12NS(int time12ns) {
        formatTime12NS = time12ns;
    }
    ...
    public static ArrayList<String> getTimeNames() {
        return timeNames;
    }
}
